...
namespace BlazorBattle.Client
{
    public class CustomerAuthProvider : AuthenticationStateProvider
    {
        ...
        public CustomerAuthProvider(ILocalStorageService localStorageService, HttpClient http)
        {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            if(!string.IsNullOrEmpty(authToken)) identity = new ClaimsIdentity(ParseClaimsFromJwt(authToken),"jwt");
